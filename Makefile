...
PATH_TO_EMCC=emcc
HEADER_FILES = canvas.h ChartJS_handler.h html_canvas.h simulation.h statistics_handler.h subject.h RegularMovementStrategy.h LockdownMovementStrategy.h
